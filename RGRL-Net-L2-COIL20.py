...
for reg2 in [1,10,100,1000,10000]:
	for reg3 in [1]:#[12,15,20]:
		for reg4 in [1,10,100,1000]:
			for learning_rate in [1e-4]:
				try:
					...
					CAE = ConvAE(n_input = n_input, n_hidden = n_hidden, reg_constant1 = reg1, re_constant2 = reg2, re_constant3 = reg3, re_constant4=reg4, kernel_size = kernel_size,

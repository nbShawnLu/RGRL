...
class ConvAE(object):
    def __init__(self, n_input, kernel_size, n_hidden, reg_constant1=1.0, re_constant2=1.0, re_constant3=1.0,re_constant4=1.0,
        ...
        self.loss2 = (reg_constant1 * self.reg_losses + re_constant2 * self.selfexpress_losses + re_constant3 * self.tracelossx + re_constant4 * self.selfexpress_losses2)
...
if __name__ == '__main__':
    ...
    for reg2 in [0.001,0.01,0.1,0.5,1,5,10,50]:
        for reg3 in [1]:
            for reg4 in [0.001,0.01,0.1,0.5,1,5,10,50]:
